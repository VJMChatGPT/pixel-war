...
import {PIXL_TEASER_DURATION, sceneTimings, seconds} from "./productWalkthrough/constants";
  ...
  return (
    <WalkthroughBrandingProvider value={octopusWalkthroughBranding}>
      <AbsoluteFill style={{overflow: "hidden"}}>
        ...
        <TransitionBridgeSequence from={sceneTimings.app.from - 10} duration={28} effects={[{type: "pixelSweep"}]} />
